...
// Due to lack of feature support in Golang assembly AARCH64 architecture,
// for instance lack of directive 'NOSPLIT', we need plenty of workaround
// to implement following opcode to assembly and construct trampoline
// in buffer. We are using opcode directly for current stage.
//
